...
$DB_PASS = 'admin111';
  ...
  $tablename = 'la_flight_pessenger_trafic_by_term';

   /* select all the weekly tasks from the table googlechart */
  $result = $mysqli->query("SELECT * FROM $tablename where passenger_count != 0 order by dataextractdate, reportperiod DESC");
  ...
  $table['cols'] = array(
    ...
    array('label' => 'terminal', 'type' => 'string'),
    ...
    foreach($result as $r) {
      ...
      $temp[] = array('v' => (string) $r['terminal']);  
      $temp[] = array('v' => (string) $r['arrival_departure']); 
      $temp[] = array('v' => (integer) $r['passenger_count']); 
