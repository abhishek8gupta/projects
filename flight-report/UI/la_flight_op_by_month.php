...
$DB_PASS = 'admin111';
  ...
  $tablename = 'la_flight_op_by_month';

   /* select all the weekly tasks from the table googlechart */
  $result = $mysqli->query("SELECT * FROM $tablename order by dataextractdate, reportperiod DESC");
  ...
  $table['cols'] = array(
    ...
    array('label' => 'flightopscount', 'type' => 'string')
    );
    ...
    foreach($result as $r) {
      ...
      $temp[] = array('v' => (string) $r['flightopscount']); 
